...
export const EyesTooltip = ({
  ...
  return (
    ...
    >
      ...
      >
        <svg onClick={() => setAttribute('avatar.eyes.style', 'eyes')}  viewBox="0 0 96 48" fill="none" xmlns="http://www.w3.org/2000/svg"
        { ...selectableStyleProps({ width: 96, height: 48 })}
        >
        ...
        <svg onClick={() => setAttribute('avatar.eyes.style', 'eyeshadow')} { ...selectableStyleProps({ width: 96, height: 49 })} viewBox="0 0 96 49" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="15.2398" cy="21.2394" r="12" transform="rotate(-6.27568 15.2398 21.2394)" fill={colorMap[state.avatar.eyeshadow.color as Color] || '#D2EFF3'} />
        <ellipse cx="16.5301" cy="30.4023" rx="9" ry="13.5" transform="rotate(-6.77646 16.5301 30.4023)" fill={colorMap[state.avatar.eyes.color as Color] || 'black'} />
        <circle cx="79.0191" cy="12.6105" r="12" transform="rotate(-6.27568 79.0191 12.6105)" fill={colorMap[state.avatar.eyeshadow.color as Color] || '#D2EFF3'} />
        <ellipse cx="80.5312" cy="20.4021" rx="9" ry="13.5" transform="rotate(-6.27568 80.5312 20.4021)" fill={colorMap[state.avatar.eyes.color as Color] || 'black'} />
        </svg>
        <svg onClick={() => setAttribute('avatar.eyes.style', 'round')} { ...selectableStyleProps({ width: 96, height: 48 })} viewBox="0 0 96 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg onClick={() => setAttribute('avatar.eyes.style', 'smiling')} { ...selectableStyleProps({ width: 96, height: 48 })} viewBox="0 0 96 48" fill="none" xmlns="http://www.w3.org/2000/svg">
